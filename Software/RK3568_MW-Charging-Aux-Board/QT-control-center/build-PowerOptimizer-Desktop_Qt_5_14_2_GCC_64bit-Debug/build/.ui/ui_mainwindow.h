...
public:
    ...
    QLabel *label_41;
    QLineEdit *lineEdit_opt_motor_x;
    QHBoxLayout *horizontalLayout_42;
    QLabel *label_32;
    QLineEdit *lineEdit_opt_motor_y;
    ...
    QLabel *label_46;
    QLineEdit *line_edit_kp_x_parameter;
    QLabel *label_47;
    QLineEdit *line_edit_ki_x_parameter;
    QLabel *label_48;
    QLineEdit *line_edit_kd_x_parameter;
    QPushButton *btn_set_x_pidcontroller_parameter;
    QPushButton *btn_stop_x_pidcontrol;
    QHBoxLayout *horizontalLayout_39;
    QLabel *label_49;
    QLineEdit *line_edit_kp_y_parameter;
    QLabel *label_50;
    QLineEdit *line_edit_ki_y_parameter;
    QLabel *label_51;
    QLineEdit *line_edit_kd_y_parameter;
    QPushButton *btn_set_y_pidcontroller_parameter;
    QPushButton *btn_stop_y_pidcontrol;
    QGroupBox *groupBox_11;
    QHBoxLayout *horizontalLayout_25;
    QWidget *turntable_position_x_chart;
    QWidget *turntable_position_y_chart;
    QWidget *tab_device_netural;
    QLabel *label_39;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setGeometry(QRect(0, 30, 1015, 561));
        QFont font1;
        ...
        group_box_stm32_connection->setGeometry(QRect(10, 10, 451, 231));
        group_box_stm32_connection->setFont(font1);
        group_box_stm32_connection->setLayoutDirection(Qt::LeftToRight);
        ...
        label_status->setTextFormat(Qt::PlainText);
        ...
        turntable_connection->setGeometry(QRect(470, 10, 521, 231));
        turntable_connection->setFont(font1);
        turntable_connection->setLayoutDirection(Qt::LeftToRight);
        ...
        connection_status->setTextFormat(Qt::PlainText);
        ...
        groupBox->setGeometry(QRect(0, 0, 1001, 71));
        ...
        groupBox_2->setGeometry(QRect(0, 71, 1001, 111));
        ...
        groupBox_7->setGeometry(QRect(0, 353, 241, 171));
        ...
        groupBox_chart->setGeometry(QRect(562, 182, 441, 341));
        ...
        groupBox_5->setGeometry(QRect(0, 182, 241, 171));
        ...
        groupBox_6->setGeometry(QRect(241, 182, 321, 341));
        ...
        horizontalLayout_16->addWidget(lineEdit_read_channel2voltagemax);
        ...
        horizontalLayout_40->addWidget(lineEdit_read_channel3voltagemax);
        ...
        horizontalLayout_41->addWidget(lineEdit_read_channel4voltagemax);
        ...
        lineEdit_opt_motor_x = new QLineEdit(groupBox_6);
        lineEdit_opt_motor_x->setObjectName(QString::fromUtf8("lineEdit_opt_motor_x"));

        horizontalLayout_43->addWidget(lineEdit_opt_motor_x);
        ...
        horizontalLayout_42->addWidget(label_32);

        lineEdit_opt_motor_y = new QLineEdit(groupBox_6);
        lineEdit_opt_motor_y->setObjectName(QString::fromUtf8("lineEdit_opt_motor_y"));

        horizontalLayout_42->addWidget(lineEdit_opt_motor_y);
        ...
        layoutWidget->setGeometry(QRect(12, 12, 981, 511));
        ...
        tableWidget_file_content->setSelectionMode(QAbstractItemView::NoSelection);
        tableWidget_file_content->setSelectionBehavior(QAbstractItemView::SelectItems);
        ...
        group_box_turntable_shape->setGeometry(QRect(0, 0, 151, 121));
        ...
        sizePolicy1.setHeightForWidth(label_turntable_img->sizePolicy().hasHeightForWidth());
        label_turntable_img->setSizePolicy(sizePolicy1);
        ...
        open_group_box_turntable_control->setGeometry(QRect(0, 121, 251, 421));
        ...
        groupBox_8->setGeometry(QRect(251, 222, 751, 71));
        horizontalLayout_38 = new QHBoxLayout(groupBox_8);
        ...
        horizontalLayout_38->addWidget(data_monitor_section);

        label = new QLabel(groupBox_8);
        label->setObjectName(QString::fromUtf8("label"));

        horizontalLayout_38->addWidget(label);
        ...
        horizontalLayout_38->addWidget(line_edit_monitor_x_pos);
        ...
        horizontalLayout_38->addWidget(line_edit_monitor_x_speed);
        ...
        horizontalLayout_38->addWidget(line_edit_monitor_y_pos);

        label_28 = new QLabel(groupBox_8);
        label_28->setObjectName(QString::fromUtf8("label_28"));

        horizontalLayout_38->addWidget(label_28);
        ...
        horizontalLayout_38->addWidget(line_edit_monitor_y_speed);

        groupBox_9 = new QGroupBox(tab_turntable_control);
        groupBox_9->setObjectName(QString::fromUtf8("groupBox_9"));
        groupBox_9->setGeometry(QRect(151, 0, 851, 121));
        ...
        combo_ref_mode->setObjectName(QString::fromUtf8("combo_ref_mode"));

        horizontalLayout_22->addWidget(combo_ref_mode);
        ...
        horizontalLayout_22->addWidget(line_edit_x_pos_ref);
        ...
        horizontalLayout_22->addWidget(line_edit_y_pos_ref);
        ...
        groupBox_10->setGeometry(QRect(251, 121, 751, 101));
        ...
        line_edit_kp_x_parameter = new QLineEdit(groupBox_10);
        line_edit_kp_x_parameter->setObjectName(QString::fromUtf8("line_edit_kp_x_parameter"));

        horizontalLayout_23->addWidget(line_edit_kp_x_parameter);
        ...
        line_edit_ki_x_parameter = new QLineEdit(groupBox_10);
        line_edit_ki_x_parameter->setObjectName(QString::fromUtf8("line_edit_ki_x_parameter"));

        horizontalLayout_23->addWidget(line_edit_ki_x_parameter);
        ...
        line_edit_kd_x_parameter = new QLineEdit(groupBox_10);
        line_edit_kd_x_parameter->setObjectName(QString::fromUtf8("line_edit_kd_x_parameter"));

        horizontalLayout_23->addWidget(line_edit_kd_x_parameter);

        btn_set_x_pidcontroller_parameter = new QPushButton(groupBox_10);
        btn_set_x_pidcontroller_parameter->setObjectName(QString::fromUtf8("btn_set_x_pidcontroller_parameter"));

        horizontalLayout_23->addWidget(btn_set_x_pidcontroller_parameter);

        btn_stop_x_pidcontrol = new QPushButton(groupBox_10);
        btn_stop_x_pidcontrol->setObjectName(QString::fromUtf8("btn_stop_x_pidcontrol"));

        horizontalLayout_23->addWidget(btn_stop_x_pidcontrol);
        ...
        horizontalLayout_39->addWidget(label_49);

        line_edit_kp_y_parameter = new QLineEdit(groupBox_10);
        line_edit_kp_y_parameter->setObjectName(QString::fromUtf8("line_edit_kp_y_parameter"));

        horizontalLayout_39->addWidget(line_edit_kp_y_parameter);
        ...
        line_edit_ki_y_parameter = new QLineEdit(groupBox_10);
        line_edit_ki_y_parameter->setObjectName(QString::fromUtf8("line_edit_ki_y_parameter"));

        horizontalLayout_39->addWidget(line_edit_ki_y_parameter);

        label_51 = new QLabel(groupBox_10);
        label_51->setObjectName(QString::fromUtf8("label_51"));

        horizontalLayout_39->addWidget(label_51);

        line_edit_kd_y_parameter = new QLineEdit(groupBox_10);
        line_edit_kd_y_parameter->setObjectName(QString::fromUtf8("line_edit_kd_y_parameter"));

        horizontalLayout_39->addWidget(line_edit_kd_y_parameter);

        btn_set_y_pidcontroller_parameter = new QPushButton(groupBox_10);
        btn_set_y_pidcontroller_parameter->setObjectName(QString::fromUtf8("btn_set_y_pidcontroller_parameter"));

        horizontalLayout_39->addWidget(btn_set_y_pidcontroller_parameter);

        btn_stop_y_pidcontrol = new QPushButton(groupBox_10);
        btn_stop_y_pidcontrol->setObjectName(QString::fromUtf8("btn_stop_y_pidcontrol"));

        horizontalLayout_39->addWidget(btn_stop_y_pidcontrol);


        verticalLayout_11->addLayout(horizontalLayout_39);

        groupBox_11 = new QGroupBox(tab_turntable_control);
        groupBox_11->setObjectName(QString::fromUtf8("groupBox_11"));
        groupBox_11->setGeometry(QRect(251, 290, 751, 241));
        horizontalLayout_25 = new QHBoxLayout(groupBox_11);
        horizontalLayout_25->setObjectName(QString::fromUtf8("horizontalLayout_25"));
        turntable_position_x_chart = new QWidget(groupBox_11);
        turntable_position_x_chart->setObjectName(QString::fromUtf8("turntable_position_x_chart"));
        sizePolicy1.setHeightForWidth(turntable_position_x_chart->sizePolicy().hasHeightForWidth());
        turntable_position_x_chart->setSizePolicy(sizePolicy1);

        horizontalLayout_25->addWidget(turntable_position_x_chart);

        turntable_position_y_chart = new QWidget(groupBox_11);
        turntable_position_y_chart->setObjectName(QString::fromUtf8("turntable_position_y_chart"));
        sizePolicy1.setHeightForWidth(turntable_position_y_chart->sizePolicy().hasHeightForWidth());
        turntable_position_y_chart->setSizePolicy(sizePolicy1);

        horizontalLayout_25->addWidget(turntable_position_y_chart);

        tabWidget->addTab(tab_turntable_control, QString());
        groupBox_11->raise();
        group_box_turntable_shape->raise();
        open_group_box_turntable_control->raise();
        groupBox_8->raise();
        groupBox_9->raise();
        groupBox_10->raise();
        tab_device_netural = new QWidget();
        tab_device_netural->setObjectName(QString::fromUtf8("tab_device_netural"));
        tabWidget->addTab(tab_device_netural, QString());
        label_39 = new QLabel(centralwidget);
        label_39->setObjectName(QString::fromUtf8("label_39"));
        label_39->setGeometry(QRect(20, 10, 141, 16));
        QFont font4;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_41->setText(QCoreApplication::translate("MainWindow", "X\345\235\220\346\240\207", nullptr));
        label_32->setText(QCoreApplication::translate("MainWindow", "Y\345\235\220\346\240\207", nullptr));
        ...
        label_31->setText(QCoreApplication::translate("MainWindow", "\350\267\237\350\270\252\346\226\271\345\274\217", nullptr));
        ...
        label_46->setText(QCoreApplication::translate("MainWindow", "KP_x", nullptr));
        label_47->setText(QCoreApplication::translate("MainWindow", "KI_x", nullptr));
        label_48->setText(QCoreApplication::translate("MainWindow", "KD_x", nullptr));
        btn_set_x_pidcontroller_parameter->setText(QCoreApplication::translate("MainWindow", "x\350\275\264PID\350\256\276\345\256\232", nullptr));
        btn_stop_x_pidcontrol->setText(QCoreApplication::translate("MainWindow", "x\350\275\264PID\345\201\234\346\255\242", nullptr));
        label_49->setText(QCoreApplication::translate("MainWindow", "KP_y", nullptr));
        label_50->setText(QCoreApplication::translate("MainWindow", "KI_y", nullptr));
        label_51->setText(QCoreApplication::translate("MainWindow", "KD_y", nullptr));
        btn_set_y_pidcontroller_parameter->setText(QCoreApplication::translate("MainWindow", "y\350\275\264PID\350\256\276\345\256\232", nullptr));
        btn_stop_y_pidcontrol->setText(QCoreApplication::translate("MainWindow", "y\350\275\264PID\345\201\234\346\255\242", nullptr));
        groupBox_11->setTitle(QCoreApplication::translate("MainWindow", "\350\275\254\345\217\260\344\275\215\347\275\256\350\267\237\350\270\252\346\233\262\347\272\277", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_device_netural), QCoreApplication::translate("MainWindow", "\347\245\236\347\273\217\347\275\221\347\273\234\350\256\255\347\273\203", nullptr));
