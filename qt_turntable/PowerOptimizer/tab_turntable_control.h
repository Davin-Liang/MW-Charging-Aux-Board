...
public slots:
    ...
    void on_btn_stop_pidcontroller_clicked();
...
private:
    ...
    // 图表
    QChart *turntableChart;
    QChartView *turntableChartView;
    QLineSeries *series_target_x, *series_target_y, *series_current_x, *series_current_y;
